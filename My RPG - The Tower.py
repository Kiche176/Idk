...
class ClubOgre(Enemy):
    def __init__(self, enemyName, enemyLevel):
        ...
        self.addMoves([skillPunch, skillKick, skillBonk])       
        self.addWeapon(club)
...
class Golem(Enemy):
    def __init__(self, enemyName, enemyLevel):
        ...
        self.resistantMoves = [{'Move' : spellStone,
                                'Amount' : 0.7}]
...
class Yeti(Enemy):
    def __init__(self, enemyName, enemyLevel):
        ...
        self.resistantMoves = [{'Move' : spellIcicle,
                                'Amount' : 0.5},
                               {'Move' : spellIceLance,
                                'Amount' : 0.7},
                               {'Move' : spellHailstorm,
...
class LavaHound(Enemy):
    def __init__(self, enemyName, enemyLevel):
        ...
        self.addMoves([skillBash, spellEmber, spellEruption, spellIgnite])        
        
        self.resistantMoves = [{'Move' : spellEmber,
                                'Amount' : 0.5},
                               {'Move' : spellEruption,
                                'Amount' : 0.7},
                               {'Move' : spellIgnite,
...
class Storm(Enemy): 
    def __init__(self, enemyName, enemyLevel):
        ...
        self.resistantMoves = [{'Move' : spellGale,
                                'Amount' : 0.5},
                               {'Move' : spellBolt,
                                'Amount' : 0.5},
                               {'Move' : spellThunderstorm,
                                'Amount' : 0.5},
                               {'Move' : spellHailstorm,
                                'Amount' : 0.5},
                               {'Move' : spellKamui,
...
def physDamage(attacker, defender, move):
    ...
    for moveResistance in defender.resistantMoves:
        if move == moveResistance["Move"]:
            finalDamage *= moveResistance["Amount"]
            break
